...
Newsfeed.ImageLoader = (function() {
    ...
    ImageLoader.prototype.preload = function() {
        ...
        this.game.load.spritesheet('diamond1', this.path + "diamond1.png", 200, 200, 7);
        this.game.load.spritesheet('diamond2', this.path + "diamond2.png", 200, 200, 7);
        this.game.load.spritesheet('diamond3', this.path + "diamond3.png", 200, 200, 7);
